...
export function Earnings() {
  ...
  }, [workerEarnings, fetchWorkerEarnings, workerId]);

  const maxAmount = workerEarnings ? Math.max(...workerEarnings.monthlyHistory.map((m) => m.amount)) : 1;
  ...
  return (
    <main className="container page-main">
      ...
      <div className="dashboard-stats-grid">
        ...
        <div className="stat-card"><Star size={22} /><strong>{workerEarnings?.averageRating || '0.0'}</strong><span>Average Rating</span></div>
      </div>
